...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{itemize}
        \item \( \big[ \widehat{A}, \widehat{B} \big] f \equiv \widehat{A} (\widehat{B} f) 
        ...
        \item \begin{tabular}[t]{c}
            ...
            \end{tabular}
        \item \( \big[ \hat{p}, f\mss{(x)} \big] = \hat{p} f\mss{(x)} = \frac{\hbar}{i} \tfrac{\partial f}{\partial x} \)
    \end{itemize}
\end{minipage}
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{empheq}[box=\fbox]{gather*}
        \Psi_0 = A e^{- \frac{m \omega}{\hbar} \frac{x^2}{2} }, 
            \hspace{10pt} A = \left( \frac{m \omega }{\pi \hbar} \right)^{1/4} 
            \\[2pt]
