...
\begin{tabular}{c|c|c}
    ...
    \( \begin{gathered}
            ...
            = \int_{-\infty}^{\infty} \Psi{\scriptstyle(y,0)} \ 
            \delta{\scriptstyle(x-y)} dy
        \end{gathered} \)
    & \( \begin{gathered}
            \Psi{\scriptstyle(x,t)} = \int_{-\infty}^{\infty} c_p \Psi_p \ dp \\[10pt]
            = \int_{-\infty}^{\infty} \Phi{\scriptstyle(p,0)}
            \left( e^{-\frac{i}{\hbar} \frac{p^2}{2m} t} \right)
            \frac{e^{\frac{i}{\hbar} px}}{\sqrt{2 \pi \hbar}} \ dp
        \end{gathered} \)
    & \( \begin{gathered}
            \Psi{\scriptstyle(x,t)} = \int_{-\infty}^{\infty} c_n \Psi_n \ dn \\[10pt]
