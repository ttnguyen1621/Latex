...
\vspace{10pt}\noindent
\underline{Elementary Elimination Matrices, \(L_k\)}
...
% Elementary Elimination Matrices
\vspace{10pt}\noindent
\underline{Elementary Elimination Matrices, \(M_k\)}
...
\vspace{10pt}
\underline{Positive Definite}:\ \ \(x^T Ax \geq 0\) \\[10pt]
\underline{Cholesky Factorization for Sym., Pos. Def.}: \ 
