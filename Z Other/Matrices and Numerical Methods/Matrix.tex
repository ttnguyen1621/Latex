...
\(\begin{aligned}
	...
	&\rightarrow\ A_1 = H^H A H = H A H\\[5pt]
	&\rightarrow\ A_{k} \ [{\scriptstyle +\ \sigma I}] = R_k Q_k^{(A)} 
		\hspace{15pt} \text{\scriptsize\((k>1)\)}\\[5pt]
	&\rightarrow\ A_{k} \ [{\scriptstyle +\ \sigma I}] = R_k \Big( A_{k-1} \ [{\scriptstyle -\ \sigma I}] \Big) R_k^{-1}
