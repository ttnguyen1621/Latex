...
\boldmath $$A(x) \ u_x + \alpha(x) \ B(y) \ u_y = f(u)$$ \unboldmath
\\ \\
$\displaystyle \frac{dy}{dx} = \frac{ \frac{dy}{dt} }{ \frac{dx}{dt} } = \frac{\alpha(x) B(y)}{A(x)}\ \ \Rightarrow\ \ \int \frac{dy}{B(y)} = \int \frac{\alpha(x)}{A(x)} dx \ \ \Rightarrow\ \ Y(y) = X(x) + C $ \\ \\
\begin{eqnarray*}
C &=& Y(y)-X(x) \\
\epsilon &=& x \\
\end{eqnarray*}
$u_x\ =\ u_C\displaystyle \frac{dC}{dx} +u_{\epsilon}\frac{d\epsilon}{dx}\ =\ \frac{-\alpha(x)}{A(x)} u_C + u_{\epsilon}$ \\ \\ \\
$u_y\ =\ u_C\displaystyle \frac{dC}{dy} +u_{\epsilon}\frac{d\epsilon}{dy}\ =\ \frac{1}{B(y)} u_C$ \\ \\
\begin{eqnarray*}
f(u) &=& A(x)u_x + \alpha(x) B(y)u_y \\ \\
&=& A(x)\left[ \frac{-\alpha(x)}{A(x)}u_C + u_{\epsilon} \right] + \frac{\alpha(x) B(y)}{B(y)}u_C \\ \\
